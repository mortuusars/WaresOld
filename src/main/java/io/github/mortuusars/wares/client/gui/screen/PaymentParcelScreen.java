...
public class PaymentParcelScreen extends BaseContainerScreen<PaymentParcelMenu> {

    private static final ResourceLocation TEXTURE = new ResourceLocation(Wares.MOD_ID, "textures/gui/payment_parcel.png");

    public PaymentParcelScreen(PaymentParcelMenu menu, Inventory playerInventory, Component title) {
