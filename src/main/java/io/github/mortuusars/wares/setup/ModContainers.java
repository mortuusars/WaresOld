...
public class ModContainers {
    ...
    public static final RegistryObject<MenuType<PurchaseRequestMenu>> PURCHASE_REQUEST = Registries.MENU_TYPES.register(
            "purchase_request", () -> IForgeMenuType.create(PurchaseRequestMenu::fromBuffer));
